...
from tc_news_rec.models.utils.features import get_sequential_features, SequentialFeatures
from tc_news_rec.models.negative_samplers.negative_samplers import GlobalNegativeSampler, InBatchNegativesSampler
...
def _test_model_forward(debug_cfg: DictConfig, fake_batch: Optional[Dict]=None):
    ...
    retrieve_model = hydra.utils.instantiate(
        model_config, 
